...
Backup is a snapshot that is uploaded to an external storage. So this operator should be able to cover the following

1. Take a database snapshot (dump)
2. Upload this snapshot to an external storage
3. Discover all the possible backup options
